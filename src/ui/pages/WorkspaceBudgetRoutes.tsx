...
export function WorkspaceBudgetRoutes(props: { workspaceId: string; api: AutonomoControlApi }) {
  return (
    <Routes>
      <Route index element={<WorkspaceBudgetEntriesPage workspaceId={props.workspaceId} api={props.api} />} />
      <Route path="new" element={<WorkspaceBudgetCreatePage workspaceId={props.workspaceId} api={props.api} />} />
